...
// ----------------------- VALIDACIONES -----------------------------
    ...
    function chequeo_cantidadE() {
      const chequeo = /^[1-9]\d*$/;
      const cantPlatos = $("#cantPlatos").val();
      if (chequeo.test(cantPlatos) && cantPlatos !== 0) {
       $(".error6").html("");
       $(".error6").hide();
                           ...
                           data:{ validar:'si', 
                            ...
                            success: function(response) {
                              if (response.resultado === "error") {
                                 ...
                                 $(".error9").html('<i  class="bi bi-exclamation-triangle-fill"></i> Un evento ya esta registrado en esa fecha y horario!');
                                 $(".error5").html('<i  class="bi bi-exclamation-triangle-fill"></i> Un evento ya esta registrado en esa fecha y horario!');
                                 $(".error5, .error9").show();
                                 $('#feMenu').addClass('errorBorder');
                                 $('.bar5').removeClass('bar');
                                 $('.ic5').addClass('l');
...
$('#evento2').addClass('text-primary');
$('.even2').addClass('active');
