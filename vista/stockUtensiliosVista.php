...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Stock de Utensilios |Servicio Nutricional UPTAEB</title>
...
<!--//////////////// SIDEBAR ///////////////////////////////////////////-->
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div class=" col-12">
                                  <h1 class="fw-bold blanco"> Stock de Utensilios </h1>
                                  <nav>
                                    <ol class="breadcrumb">
                                    <?php 
                                      ...
                                      if(isset($permisos['Inventario de Utensilios']['registrar']) ){
                                        echo '    <li class="breadcrumb-item fw-bold"><a href="?url='.urlencode($sistem->encryptURL('entradaUtensilios')).'">Registrar Entrada de Utensilios</a></li>';
                                      }
                                     ?> 
 ...
 <div class="conatiner-fluid content-inner mt-n5 py-0">
          ...
          <div class="col-sm-12">
              <div class="card" data-aos="fade-up" data-aos-delay="700">
                  ...
                  <div class="mb-3" align="end">  
                          <a href="#" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3" data-bs-toggle="modal" data-bs-target="#pdfStockUtensilios">
              ...
              <div class="modal fade" id="pdfStockUtensilios" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          ...
          <div class="modal-content">
               <div class="modal-header bg-azul4">
                 ...
                 <div class="modal-body mb-2 ">
                   ...
                   <h5 class="text-center">¿Deseas Descargar el stock de los utensilios?</h5>
                </div>
   ...
   <?php $configuracion->configuracion(); ?>
     ...
     <script  type="text/javascript" src="assets/js/inventarioUtensilios/stockUtensilios.js"></script> 
  </body>
</html>