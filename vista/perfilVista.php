  ...
  <body>
    ...
    <main class="main-content">
                      ...
                      <ol class="breadcrumb">
                        <?php 
                          if (isset($permisos['Home']['consultar'])) {
                            echo '<li class="breadcrumb-item fw-bold"><a href="?url='.$sistem->encryptURL('home').'">Inicio</a></li>';
                          }
                          echo '<li class="breadcrumb-item fw-bold"><a href="?url='.$sistem->encryptURL('ayuda').'">Ayuda</a></li>';
                        ?>
                      </ol>
                    </nav>
                  </div>
      ...
      <div class="container-fluid content-inner mt-n5 mt-4 py-0 row">
            ...
            <div class="card-body">
              <form class="formu form1">
                  ...
                  <div class="row container">
                    <div class="wave-group p-2 my-2 mb-2">
                      <div id="container0" class="contai">
                        <img id="imgPreview" width="250" height="250" alt="Profile" class="rounded-circle mb-2" src="<?php echo $_SESSION['img']; ?>">
                      </div>      
                    </div> 
                    <div class="wave-group p-2 my-2 mb-2">
                ...
                <div class="row" align="center">
                  <div class="col-md-6">
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#imgEliminar">Borrar</button>
                  </div>
                  <div class="col-md-6">
        ...
        <div class="modal fade" id="imgEliminar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header bg-azul4">
                <h5 class="modal-title title" id="staticBackdropLabel">Eliminar Foto de Perfil</h5>
              ...
              <form method="POST" id="eliminar">
                <div class="modal-body mb-2">
                  ...
                  <h5 class="imgEliminar text-center">¿Desea eliminar la foto de perfil?</h5>
                </div>
                <div class="modal-footer">
                  <div class="text-start">
                    <button type="button" class="btn btn-danger" aria-label="Close" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="eliminarIMG">Eliminar</button>
                  </div>
                </div>
              </form>
            </div>
...
<!-- Footer Section End -->
    ...
    <?php $configuracion->configuracion(); ?>
     ...
     <script>
        var reset_password_mode = <?php echo isset($_SESSION['reset_password_mode']) && $_SESSION['reset_password_mode'] === true ? 'true' : 'false'; ?>;
    </script>
