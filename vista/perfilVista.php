        ...
        <div class="col-md-8 mt-3">
          <div class="card shadow" data-aos="fade-up" data-aos-delay="700">
                    ...
                    <p  class=" text-center l er error3"  ></p>
                           ...
                           <fieldset id="form2">
                            ...
                            <p  class=" text-center l er error4"  ></p>
                                ...
                                <div class="col-1" style="margin-left: -25px!important; margin-top:12px!important;" id="eye"><i class="labelPri ojo ey1" >
            ...
            <br>
                            ...
                            <p  class=" text-center l er error5"  ></p>
                                ...
                                <div class="col-1" style="margin-left: -25px!important; margin-top:12px!important;" id="eye2"><i class="labelPri ojo ey2"  >
         ...
         <br>
                            ...
                            <p  class=" text-center l er error6"  ></p>
                                ...
                                <div class="col-1" style="margin-left: -25px!important; margin-top:12px!important;" id="eye3"><i class="labelPri ojo ey3" >
