   ...
   <div class="position-relative iq-banner">
    ...
    <div class="iq-navbar-header" style="height: 215px;">
         ...
         <div class="col-md-7">
          ...
          <nav>
           ...
           <?php 
            ...
            if(isset($permisos['Menú']['registrar']) ){
               echo '
                <li class="breadcrumb-item fw-bold"><a href="?url='.urlencode($sistem->encryptURL('menu')).'">Registrar Menú</a></li>';
           }
           ?>
     ...
     <div class="iq-header-img">
      <img alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX" src="assets/images/dashboard/header.png"/>
     </div>
    </div>
     ...
     <div class="row">
      <div class="col-sm-12">
       <div class="card" data-aos="fade-up" data-aos-delay="700">
        <div class="card-body">
         <div class="row" id="ani2">
          <div class="mb-1 col-md-8">
           <div class="d-flex">
            <div class="checkbox p-1">
             <input class="activarFiltro" id="cbx" type="checkbox"/>
             <label class="toggle" for="cbx">
              <span>
              </span>
             </label>
            </div>
          ...
          <div class="buscar mt-2 row justify-content-center">
           <div class="wave-group p-3 col-md-5">
            <input class="input center fecha mt-2" id="fecha" required="" type="date"/>
            <span class="bar bar1">
            </span>
            ...
            <p class="text-center l er error1">
            </p>
           </div>
           <div class="wave-group p-3 col-md-5">
            <input class="input fecha2 mt-2" id="fecha2" required="" style="align-items: center !important;" type="date"/>
            <span class="bar bar2">
            </span>
            ...
            <p class="text-center l er error2">
            </p>
           </div>
          </div>
          ...
          <div class="table-responsive">
           <table class="table table-bordered table-hover tabla">
            <thead class="table-success">
             <tr>
              <th class="blanco fw-bold text-center">
               Fecha
              </th>
              <th class="blanco fw-bold text-center">
               Horario
              ...
              <th class="blanco fw-bold accion text-center">
               Acciones
              </th>
             </tr>
            </thead>
    ...
    <div aria-hidden="true" aria-labelledby="staticBackdropLabel" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="infoMenu" tabindex="-1">
     <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
       <div class="modal-header bg-azul4">
        ...
        <button aria-label="Close" class="btn-close cut" data-bs-dismiss="modal" type="button">
        </button>
       </div>
     ...
     <!-- MODAL EDITAR -->
     <div aria-hidden="true" aria-labelledby="staticBackdropLabel" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="modificarMenu" tabindex="-1">
      ...
      <input type="hidden" name="csrf_token" id="tokenCsrfModificar" value="<?php echo htmlspecialchars($tokenCsrf); ?>">
         ...
         <div class="row mt-1 p-3" id="menu1">
          ...
          <div class="wave-group p-1 col-md-6 my-1">
           <input class="input feMenu mt-2" id="feMenu" required="" type="date"/>
           <input type="hidden" id="idd" name="">
           <input type="hidden" id="idSalidaA" value="">
           ...
           <label class="label labelPri ic6">
            ...
            <span class="label-char letra6" style="--index: 0">
             Fecha
            </span>
           </label>
           <p class="text-center l er error6">
           </p>
          </div>

          <div class="wave-group p-1 col-md-6 my-1">
           <input class="input cantPlatos mt-2" id="cantPlatos" required="" type="number"/>
           <span class="bar bar7">
           </span>
           <label class="label labelPri ic7">
            <span class="label-char pl-2 letra7" style="--index: 0; margin-right: 3px!important;">
             <i class="ri-restaurant-2-line " ></i> 
            </span>
            <span class="label-char letra7" style="--index: 0">
             N° de Platos
            </span>
           </label>
           <p class="text-center l er error7">
           </p>
          </div>
              <?php if (isset($payload->horario_comida)) {

                             echo ' <div class="wave-group p-1 col-md-12 my-1 d-none" id="tablita">
                       <div class="table-responsive table-wrapper">
                        <table  class="table table-bordered table-hover " id="horarioComida">
                             <thead class="table-success center">
                              ...
                              <tbody id="horarioC">
                              <tr>
                        <th class="text-primary text-center">'.htmlspecialchars($payload->horario_comida).'
                            <div class="form-check d-flex justify-content-center align-items-center">
                                <input class="form-check-input checkHorarioComida opcion" type="checkbox" name="opcion" checked="checked"
                                    id="checkDesayuno" value="'.htmlspecialchars($payload->horario_comida).'">
                            </div>
                        </th>
                    </tr>
        ...
        <div class="modal-content">
          ...
          <div class="col-12">
            ...
            <div align="end" class="mb-3 mt-2">
                               <button class="btn btn-primary mb-3" data-bs-target="#modificarMenu" data-bs-toggle="modal" style="height: 35px;display: flex; align-items: center;">Regresar</button>
                           </div>
...
<path fill="currentColor" opacity="1.00" d=" M 575.42 428.75 C 581.43 432.66 587.31 436.75 593.19 440.86 C 588.50 447.54 583.96 454.33 579.30 461.03 C 587.32 459.56 595.25 457.63 603.27 456.10 C 604.70 463.07 606.33 470.00 607.58 477.02 C 597.08 479.22 586.60 481.51 576.09 483.64 C 584.92 493.15 593.90 502.54 602.68 512.10 C 597.49 516.99 592.32 521.90 587.06 526.71 C 573.81 512.45 560.30 498.45 547.27 484.00 C 548.28 499.88 542.31 515.92 531.41 527.46 C 527.37 531.42 523.67 535.78 519.05 539.11 C 509.57 546.24 497.94 550.76 486.02 551.00 C 330.00 551.01 173.98 550.98 17.96 551.01 C 11.20 551.17 4.92 544.83 5.44 538.01 C 5.31 532.22 9.86 526.77 15.55 525.76 C 62.82 516.15 110.05 506.38 157.34 496.88 C 156.76 503.33 155.00 509.57 153.31 515.79 C 159.88 517.85 166.29 520.39 172.81 522.59 C 176.05 512.85 178.06 502.70 178.60 492.44 C 195.89 488.97 213.16 485.33 230.46 481.90 C 230.07 490.29 228.41 498.56 225.95 506.58 C 232.44 508.88 238.90 511.25 245.37 513.62 C 249.48 502.20 251.39 490.00 251.29 477.88 C 268.53 473.99 285.92 470.67 303.25 467.11 C 303.39 477.42 301.93 487.78 298.56 497.54 C 305.07 499.90 311.63 502.14 318.13 504.53 C 322.66 491.19 324.67 476.95 323.70 462.89 C 340.97 459.40 358.24 455.86 375.49 452.28 C 376.49 464.47 375.26 476.87 371.26 488.46 C 377.79 490.75 384.30 493.13 390.84 495.41 C 396.03 480.27 397.67 464.01 395.84 448.13 C 416.14 444.02 436.43 439.85 456.73 435.71 C 457.67 446.69 456.40 457.80 453.47 468.40 C 460.16 470.18 466.85 471.96 473.56 473.64 C 477.41 460.00 478.77 445.62 477.16 431.52 C 489.56 428.92 502.88 430.08 514.37 435.56 C 529.59 442.62 541.28 456.81 545.32 473.09 C 555.00 458.07 565.48 443.60 575.42 428.75 Z" />
                      ...
                      <div class="card shadow" id="tablaD">
                        <div class="card-body">
                          ...
                          <table class="table tables table-bordered table-hover tabla2" id="tabla2" >
                              <thead class="table-success">
                                  <tr>
                                    <th colspan="4" class="blanco fw-bold text-center">Stock Disponible</th>
                                  </tr>
                              </thead>
    ...
    <!-- MODAL BORRAR -->
    <div aria-hidden="true" aria-labelledby="staticBackdropLabel" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="borrarM" tabindex="-1">
     <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
       <div class="modal-header bg-azul4">
        ...
        <button aria-label="Close" class="btn-close btn-primary" data-bs-dismiss="modal" type="button">
        </button>
       </div>
       <form method="POST">
        ...
        <div class="modal-body mb-2">
         ...
         <h5 class="eliminarM text-center">
         </h5>
         <input id="idM" name="" type="hidden"/>
        </div>
        <div class="modal-footer">
         <div class="text-start">
          <button aria-label="Close" class="btn btn-danger" data-bs-dismiss="modal" id="cerrar3" type="button">
           Cancelar
          </button>
          <button class="btn btn-primary" id="borrar" name="borrar" type="button">
           Eliminar
          </button>
         </div>
        </div>
      ...
      <!-- MODAL PDF -->
      <div class="modal fade" id="pdfMenu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
               <div class="modal-header bg-azul4">
                 ...
                 <div class="modal-body mb-2 ">
                   ...
                   <h5 class="text-center"> ¿Deseas Descargar el Menú?</h5>
  ...
  <script src="assets/js/menu/consultarMenu.js" type="text/javascript">
  </script>
