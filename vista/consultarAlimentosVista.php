...
<head>
  ...
  <title>Consultar Alimentos | Servicio Nutricional UPTAEB</title>
...
<body class="  ">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div class=" col-md-7">
                  <h1 class="fw-bold blanco">Consultar Alimentos</h1>
                  <nav>
                    <ol class="breadcrumb">
                      <?php
                      ...
                      if (isset($permisos['Alimentos']['registrar'])) {
                        echo '
                                      <li class="breadcrumb-item fw-bold"><a href="?url=' . urlencode($sistem->encryptURL('alimentos')) . '"> Registrar Alimentos</a></li>';
                      }
              ...
              <div class="card-body">
                <div class="mb-2 col-md-8">
                  <div class=" d-flex">
                    ...
                    <div class="p-1">
                      <span>Buscar por Tipos de Alimentos</span>
                    </div>
                ...
                <div class="buscar mt-3 ">
                  <div class="wave-group p-2 col-md-6 my-2 " id="sel3" style="margin-top: 1.7vw!important">
                    ...
                    <select class="input tipoA2" id="tipoA2">

                    </select>
                    <span class="bar bar2A"></span>
                    <label class="label labelPri ic2A">
                      <span class="label-char pl-2 letra2A" style="--index: 0; margin-right: 3px!important;"> <i
                          class=" ">
  ...
  <div class="modal fade" id="infoAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-azul4">
          <h5 class="modal-title title" id="staticBackdropLabel">Información del Alimento</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body mb-2 mt-2 row">
          <div class="col-12 col-md-4 m-auto mb-2" id="imag" align="center">
          ...
          <div class="col-12 col-md-8">
            <div class="table-responsive">
              <table class="table table-hover table-bordered">
                <thead class="table-success">
                  <tr>
                    <th class="blanco">Tipo de Alimento</th>
  ...
  <!-- MODAL EDITAR -->
  <div class="modal fade" id="editarAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-azul4">

          <h5 class="modal-title title" id="staticBackdropLabel">Modificar Alimento</h5>
          <button type="button" class="btn-close btn-primary limpiar cerrar2 " aria-label="Close"
        ...
        <div class="modal-body mb-2">
          ...
          <div class="editarInfo">
            ...
            <div class="mb-2" id="image" align="center"></div>

            <div align="center">
              <button type="button" class="btn btn-primary editarI blanco mb-2"><i>
            ...
            <form class="row mt-3 p-3">
                  ...
                  <span class="label-char pl-2 letra3" style="--index: 0; margin-right: 3px!important;"> <i class=" ">
                      <svg class="icon-24" viewBox="0 0 612 612" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g id="#007afcff">
                          ...
                          <path fill="currentColor" opacity="1.00" d6.31 335.07 112.03 337.38 128.36 C 317.00 125.68
                            297.68 115.27 284.36 99.60 C 273.71 87.29 266.97 71.81 264.64 55.74 Z" />=" M 264.64 55.74 C
                          284.79 58.39 303.87 68.56 317.17 83.94 C 328.13 9
                          <path fill="currentColor" opacity="1.00"
              ...
              <div class="wave-group p-2 col-md-6 my-2" style="margin-top: 1.7vw!important;">
                <div>

                  <input class="form-check-input check" type="checkbox" id="acMarca"
                    style="margin-top: -0.6vw!important" checked>
               ...
               <div class=" p-2 col-md-6" >
                          <div  id="sel2"  style="margin-top: 1.7vw!important; display:flex; gap:10px; align-items:flex-end;">
  
  <!-- Input Cantidad (más pequeño) -->
  <div class="wave-group " style="flex:2;" id="cant">
    <input type="number" class="input" id="cantidad" required>
    <span class="bar"></span>
    <label class="label labelPri ic6">
      <span class="label-char letra6" style="--index:0">C</span>
      <span class="label-char letra6" style="--index:1">o</span>
      <span class="label-char letra6" style="--index:2">n</span>
      <span class="label-char letra6" style="--index: 3; margin-right: 3px!important;">t</span>
      <span class="label-char letra6" style="--index: 4">N</span>
      <span class="label-char letra6" style="--index: 5">e</span>
      <span class="label-char letra6" style="--index: 6">t</span>
      <span class="label-char letra6" style="--index: 7">o</span>
    </label>
    </label>
  </div>
  ...
  <div class="wave-group" style="flex:3;">
    ...
    <label class="label labelPri ic5">
       <span class="label-char pl-2 letra5" style="--index: 0; margin-right: 3px!important;"> <i class=" ">
                      <svg class='icon-24' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
    ...
    <span class="label-char letra5" style="--index:0">M</span>
    <span class="label-char letra5" style="--index:1">e</span>
    <span class="label-char letra5" style="--index:2">d</span>
    <span class="label-char letra5" style="--index:3">i</span>
    <span class="label-char letra5" style="--index:4">d</span>
...
<p class=" text-center l er error6"></p>
              ...
              <div class="modal-footer">
                <div class="text-start">
                  <button type="button" class="btn btn-danger  blanco limpiar cance">Cancelar</button>
                  <button id="edita" type="button" class="btn btn-primary blanco">Modificar</button>
          ...
          <div class="editarImagen ">
            <form class="formIMG">
              ...
              <div class="wave-group p-2  my-3 mb-2">
                ...
                <label class="label labelPri ic1">
                  <span class="label-char pl-2 letra"
                    style="--index: 0; margin-right: 3px!important; font-size: 18px!important"> <i
                      class=" ri-image-fill ">
              ...
              <div class="modal-footer">
                <div class="text-start">
                  <button type="button" class="btn btn-danger  blanco cance" id="resetear">Cancelar</button>
                  <button id="editarIMG" type="button" class="btn btn-primary blanco">Modificar</button>
  ...
  <div class="modal fade" id="borrarAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-azul4">
          <h5 class="modal-title title" id="staticBackdropLabel">Anular Alimento</h5>
        ...
        <form method="POST" id="eliminarU">
          ...
          <div class="modal-body mb-2">
            ...
            <h5 class="eliminarA text-center"></h5>
  ...
  <script type="text/javascript" src="assets/js/alimentos/consultarAlimentos.js"></script>
