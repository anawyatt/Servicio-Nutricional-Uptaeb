...
<body class="  ">
                  ...
                  <nav>
                    <ol class="breadcrumb">
                      ...
                      if (isset($permisos['Inventario de Alimentos']['registrar'])) {
                        echo '
                                      <li class="breadcrumb-item fw-bold"><a href="?url=' . urlencode($sistem->encryptURL('salidaAlimentos')) . '"> Registrar Salida de Alimentos</a></li>';
                      }
              ...
              <div class="card-body">
                ...
                <div id="ani" class="row">
                  ...
                  <div class="col-md-4 mb-3" align="end">
                    <button disabled="true" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3"
                      data-bs-toggle="modal" data-bs-target="#pdfSalidaTotal" id="botonPDF">
                  ...
                  <div class="buscar mt-3 row">
                    <div class="wave-group p-2 col-md-6">
                      ...
                      <label class="label labelPri ic1 ">
                        <span class="label-char pl-2 letra1" style="--index: 0; margin-right: 3px!important;"> <i
                            class=" ">
                            <svg class="icon-22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="modal fade" id="infoSAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
  ...
  <div class="modal fade" id="borrarSAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="pdfSAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-azul4">
  ...
  <div class="modal fade" id="pdfSalidaTotal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-azul4">
