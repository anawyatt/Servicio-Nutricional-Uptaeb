...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Consultar Utensilios |Servicio Nutricional UPTAEB</title>
...
<!--//////////////// SIDEBAR ///////////////////////////////////////////-->
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div class=" col-md-7">
                                  <h1 class="fw-bold blanco">Consultar Utensilios</h1>
                                  <nav>
                                    <ol class="breadcrumb">
                                    <?php 
                                    ...
                                    if(isset($permisos['Utensilios']['registrar']) ){
                                      echo '
                                          <li class="breadcrumb-item fw-bold"><a href="?url='.urlencode( $sistem->encryptURL('utensilios')).'">Registrar Utensilios</a></li>';
                                    }
                                    ?> 
                                     </ol>
                                  </nav>
 ...
 <div class="conatiner-fluid content-inner mt-n5 py-0">
        ...
        <!-- MODAL ver informacion -->
                    <div class="modal fade" id="infoUtensilio" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered modal-lg">
                                  <div class="modal-content">
                                      <div class="modal-header bg-azul4">
                                          <h5 class="modal-title title" id="staticBackdropLabel">Información del Utensilio</h5>
     ...
     <!-- MODAL EDITAR -->
     <div class="modal fade" id="editarUtensilio" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered modal-lg">
                                  <div class="modal-content">
                                      <div class="modal-header bg-azul4">
                                        
                                          <h5 class="modal-title title" id="staticBackdropLabel">Modificar Utensilio</h5>
...
<path fill="currentColor" opacity="1.00" d=" M 52.18 79.48 C 54.65 78.59 57.01 77.43 59.22 76.02 C 59.18 90.01 65.25 103.91 75.75 113.18 C 87.18 123.73 103.79 128.08 118.98 125.13 C 135.51 122.13 150.12 110.02 155.91 94.23 C 158.64 101.01 165.56 105.28 172.64 106.14 C 166.29 118.93 156.19 129.75 143.71 136.71 C 129.43 144.99 112.06 147.85 95.89 144.53 C 78.72 141.41 63.20 131.17 52.89 117.18 C 51.90 115.94 52.22 114.25 52.09 112.79 C 52.25 101.69 52.16 90.59 52.18 79.48 Z" />
        ...
        <input type="file" class=" input imagen" id="fileInput0">
                    ...
                    <label class="label labelPri ic1">
                      ...
                      <span class="label-char letra" style="--index: 8">l</span>
                      <span class="label-char letra" style="--index: 8">i</span>
       ...
       <div class="modal fade" id="borrarUtensilio" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                      <div class="modal-header bg-azul4">
                                          <h5 class="modal-title title" id="staticBackdropLabel">Anular Utensilio</h5>
   ...
   <?php $configuracion->configuracion(); ?>
     ...
     <script  type="text/javascript" src="assets/js/utensilios/consultarUtensilios.js"></script> 
  </body>
</html>