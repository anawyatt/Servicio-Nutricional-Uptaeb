...
<head>
  ...
  <title>Consultar Entrada de Alimentos | Servicio Nutricional UPTAEB</title>
...
<body class="  ">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div class=" col-12">
                  <h1 class="fw-bold blanco">Consultar Entrada de Alimentos </h1>
                  <nav>
                    <ol class="breadcrumb">
                      <?php
                      ...
                      if (isset($permisos['Inventario de Alimentos']['registrar'])) {
                        echo '
                                     <li class="breadcrumb-item fw-bold"><a href="?url=' . urlencode($sistem->encryptURL('registrarEntradaAlimentos')) . '"> Registrar Entrada de Alimentos</a></li>';
                      }
                      ?>
                ...
                <div id="ani" class="row">
                  ...
                  <div class="col-md-4 mb-3" align="end">
                    <button disabled="true" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3"
                      data-bs-toggle="modal" data-bs-target="#pdfEntradaTotal" id="botonPDF">
  ...
  <div class="modal fade" id="infoEAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-azul4">
          <h5 class="modal-title title" id="staticBackdropLabel">Información de la Entrada de Alimentos</h5>
  ...
  <div class="modal fade" id="borrarEAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-azul4">
          <h5 class="modal-title title" id="staticBackdropLabel">Anular Entrada de Alimentos</h5>
  ...
  <div class="modal fade" id="pdfEAlimento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-azul4">
        ...
        <form method="POST" id="idReporte" target="_blank" style="display: inline;">
          ...
          <div class="modal-body mb-2 ">
            ...
            <h5 class="text-center"> Deseas Descargar la entrada de alimentos?</h5>
            <input type="hidden" id='idEntradaAA'>
          </div>
  ...
  <div class="modal fade" id="pdfEntradaTotal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-azul4">
  ...
  <script type="text/javascript" src="assets/js/inventarioAlimentos/consultarEntrada.js"></script>
