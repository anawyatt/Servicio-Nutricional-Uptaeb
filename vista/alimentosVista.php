              ...
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div class=" col-md-7">
                  ...
                  <nav>
                    <ol class="breadcrumb">
                      <?php
                      if (isset($permisos['Home'])) {
                        echo '
                                        <li class="breadcrumb-item fw-bold"><a href="?url=' . urlencode($sistem->encryptURL('home')) . '">Inicio</a></li>';
                      }
                      if (isset($permisos['Alimentos']['consultar'])) {
                        echo '
                                        <li class="breadcrumb-item fw-bold"><a href="?url=' . urlencode($sistem->encryptURL('consultarAlimentos')) . '"> Consultar Alimentos</a></li>';
                      }
                      ?>
                        ...
                        <div class="wave-group p-2 col-md-6 my-2 " id="sel" style="margin-top: 1.7vw!important">
                          ...
                          <label class="label labelPri ic2">
                            <span class="label-char pl-2 letra2" style="--index: 0; margin-right: 3px!important;"> <i
                                class=" ">
                                <svg class="icon-24" viewBox="0 0 123 164" version="1.1"
                        ...
                        <div class="wave-group p-2 col-md-6 my-2" style="margin-top: 1.7vw!important;">
                          <div>
                            ...
                            <input class="form-check-input check" type="checkbox" id="acMarca"
                              style="margin-top: -0.6vw!important">
                            <label class="label labelPri ic4"
                              style="margin-left: 2vw!important; margin-top: -1.2vw!important;">
...
<p class=" text-center l er error5"></p>
                    ...
                    <button type="button" name="next" class="btn btn-primary next action-button float-end"
                      id="registrar" value="Next">Registrar</button>
