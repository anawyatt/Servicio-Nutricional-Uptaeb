...
<head>
    ...
    <title>Login | Servicio Nutricional UPTAEB</title>
    ...
    <div class="container  d-md-block" id="container">
        <div class="form-container sign-up">
            <form>
                ...
                <h1 class="text-center mb-2 ">Recuperar Contraseña</h1>

                <span class='mb-2 text-center'>Ingresa tu correo electrónico para recuperar tu contraseña</span>
                <div class="wave-group col-10 mt-3 mb-3">
                    <input required="" type="text" class="input correo" id="correo">
                    ...
                    <label class="label labelPri ic3">
                        ...
                        <span class="label-char letra3" style="--index: 0">Correo Eléctronico</span>
                    </label>
                ...
                <a class=" mb-1 d-md-none d-block azul d-block d-md-none" id="login2">
                    Volver al Login
                </a>

                <button type="button" class="button2" id="recuperar">Recuperar Contraseña</button>

            </form>
        </div>
        <div class="form-container sign-in " align="center">
            <form class="miLogin" autocomplete="off">
                <div align='center' class='mb-2 d-block d-md-none'>
                    <img src="assets/images/logos/logo.png" class='' alt="" align='center' width='150' height='100'>
                </div>
                <h1 class='mb-2'>Iniciar Sesión</h1>
                <span class='mb-2 text-center'>Inicia sesión para permanecer conectado</span>
                <div class="wave-group col-11 mt-4 mb-4">

                    <input required="" type="text" class="input cedula" autocomplete="off">
                    ...
                    <label class="label labelPri ic1">
                        ...
                        <span class="label-char letra" style="--index: 0">Usuario</span>
                ...
                <div class="wave-group col-11  mb-4 row">
                    ...
                    <div class="col-11">
                        <input required="" type="password" class="input clave" id="clave" autocomplete="off">
                        ...
                        <label class="label labelPri ic2">
                            ...
                            <span class="label-char letra2" style="--index: 0">Contraseña</span>
                ...
                <a class=" mt-2 mb-3 d-md-none d-block azul" id="register2">
                    ¿Has olvidado tu contraseña?
                </a>

                <button type="submit" class="button2" id="iniciar">Iniciar Sesión</button>
                <button class="d-none" type="reset" id="borrarL"></button>
            </form>
        </div>
