<?php 
  ...
  if(isset($_POST['mensaje'])){
	...
	$configuracion = '
                <a class="btn btn-fixed-end btn-primary btn-icon btn-setting" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" role="button" aria-controls="offcanvasExample">
