...
INSERT INTO `notificaciones` VALUES (1,'Nuevo Tipo de Utensilio','Se ha registrado un nuevo tipo de utensilio llamado: Bandejas','informacion','0000-00-00'),(2,'Registro de Salida de Alimentos','Se registro una salida de alimentos en la fecha y hora: 2025-08-30 - 15:44 la cual describe que es :  Se pudrieron','informacion','0000-00-00'),(3,'Salida de Merma','Se ha realizado una salida por motivo de Merma en la fecha y hora:2025-08-30-15:44','informacion','0000-00-00'),(4,'Registro de Salida de Alimentos','Se registro una salida de alimentos en la fecha y hora: 2025-08-30 - 15:44 la cual describe que es :  Se partieron','informacion','0000-00-00'),(5,'Salida de Merma','Se ha realizado una salida por motivo de Merma en la fecha y hora:2025-08-30-15:44','informacion','0000-00-00'),(6,'Registro de Salida de Alimentos','Se registro una salida de alimentos en la fecha y hora: 2025-08-30 - 15:45 la cual describe que es :  Se venció ','informacion','0000-00-00'),(7,'Salida de Merma','Se ha realizado una salida por motivo de Merma en la fecha y hora:2025-08-30-15:45','informacion','0000-00-00'),(8,'Registro de Salida de Alimentos','Se registro una salida de alimentos en la fecha y hora: 2025-09-02 - 20:05 la cual describe que es :  Se dañaron los aliños verdes','informacion','0000-00-00'),(9,'Salida de Merma','Se ha realizado una salida por motivo de Merma en la fecha y hora:2025-09-02-20:05','informacion','0000-00-00'),(10,'Registro de Entrada de Alimentos','Se registro una entrada de alimentos en la fecha y hora: 2025-08-30 - 12:23 la cual describe que es :  compra de alimentos','informacion','0000-00-00'),(11,'Registro de Salida de Alimentos','Se registro una salida de alimentos en la fecha y hora: 2025-08-25 - 13:20 la cual describe que es :  se daño en el transporte','informacion','0000-00-00'),(12,'Salida de Merma','Se ha realizado una salida por motivo de Merma en la fecha y hora:2025-08-25-13:20','informacion','0000-00-00'),(13,'Menú Del Dia - Desayuno','Descripción: Arepa con salsa rosado y huevo sancochado hecho para 80° comensales. Su asistencia esta disponible para el registro','Desayuno','2025-09-11'),(14,'Registro de menú','Se registro un menú para 80° Comensales  para el dia 2025-09-11 en el horario: Desayuno','informacion','0000-00-00');
...
INSERT INTO `notificaciones_usuarios` VALUES (12345678,1,0),(12345678,2,0),(12345678,3,0),(12345678,4,0),(12345678,5,0),(12345678,6,0),(12345678,7,0),(12345678,8,0),(12345678,9,0),(12345678,10,0),(12345678,11,0),(12345678,12,0),(12345678,13,0),(12345678,14,0);
...
INSERT INTO `usuario` VALUES (12345678,'assets/images/perfil/user.png','Servicio','Andres','Nutricional','Eloy','ydjYy701fmCFBES2ecJ1SZm0WBfzpLfIVL0IAnlf52VBbvcNHQ/Ey1csGeE6ASwN','0424 - 0000099','$2y$10$QWlk7uU57a5FtJNiAtdO6O.zq8zTvZMCj01u50MQCB2UerMArQgjS',1,1);
...
-- Dump completed on 2025-09-03 20:09:14
