<?php
    ...
    if (isset($_POST['renovarToken']) && $_POST['renovarToken'] == true && isset($_POST['csrfToken'])) {
        ...
        if (isset($_POST['select2']) && isset($_POST['tipoA'])) {
         ...
         if(isset($_POST['registrar']) && isset($_POST['feMenu'])  && isset($_POST['horarioComida']) && 
         isset($_POST['cantPlatos']) && isset($_POST['descripcion'])&& isset($_POST['csrfToken'])  ){
          ...
          $registrarM= $object->registrarMenu($_POST['feMenu'] , $_POST['horarioComida'], $_POST['cantPlatos'],  
          $_POST['descripcion']); 
          if (!isset($registrarM['resultado']) || $registrarM['resultado'] !== 'registrado') {
              echo json_encode([
                  'resultado' => 'error',
                  'mensaje' => $registrarM,
          ...
          echo json_encode([
              'resultado' => 'exitoso',
              'menuId' => $registrarM['menuId'],
              'salidaId' => $registrarM['salidaId'],
              'newCsrfToken' => $csrf['newToken']
          ]);
          die();
